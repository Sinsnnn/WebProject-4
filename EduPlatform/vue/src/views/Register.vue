<template>
  <div style="height: 100vh; overflow: hidden">
    <div style="
      ...
      ">
      <div style="flex: 1">
        <img src="@/assets/imgs/register.svg" alt="" style="width: 100%" />
      </div>
      <div style="flex: 1; display: flex; justify-content: center">
        <div style="width: 50%">
          ...
          <el-form :model="data.form" ref="formRef" :rules="data.rules">
            ...
            <el-form-item>
              <el-input size="large" :prefix-icon="Lock" show-password placeholder="请确认密码"
                v-model="data.form.nmm"></el-input>
            </el-form-item>
            <el-form-item>
